...
namespace PSFileParse.PE
{
    ...
    // };
    // 
    internal class ImageOptionalHeader32
    {
        ...
        public Int32 SizeOfStackReserve { get; }
        public Int32 SizeOfStackCommit { get; }
        public Int32 SizeOfHeapReserve { get; }
        public Int32 SizeOfHeapCommit { get; }
        public Int32 LoaderFlags { get; }
        public Int32 NumberOfRvaAndSizes { get; }
        public ImageDataDirectories DataDirectory { get; }
        internal static readonly UInt32 SizeOfStruct = 0xE0;


        internal ImageOptionalHeader32(byte[] filebytes, UInt32 offset)
        {
            ...
            ImageBase = BinaryHelper.ToInt32(filebytes, offset + 28);
            ...
            SizeOfStackReserve = BinaryHelper.ToInt32(filebytes, offset + 72);
            SizeOfStackCommit = BinaryHelper.ToInt32(filebytes, offset + 76);
            SizeOfHeapReserve = BinaryHelper.ToInt32(filebytes, offset + 80);
            SizeOfHeapCommit = BinaryHelper.ToInt32(filebytes, offset + 84);
            LoaderFlags = BinaryHelper.ToInt32(filebytes, offset + 88);
            NumberOfRvaAndSizes = BinaryHelper.ToInt32(filebytes, offset + 92);
            DataDirectory = new ImageDataDirectories(filebytes, offset + 96);
        }
